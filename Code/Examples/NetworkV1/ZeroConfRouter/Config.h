...
#if defined (FULL_DEBUG)
	#define STARTUP_AUTOCONFIG_INIT_TIMEOUT	30000
	#define STARTUP_AUTOCONFIG_DEINIT_TIMEOUT	300000
#else
	#define STARTUP_AUTOCONFIG_INIT_TIMEOUT	5000
	#define STARTUP_AUTOCONFIG_DEINIT_TIMEOUT	10000
#endif
