 ...
 */
#ifndef __TEST_BASERF_BASECOMMANDS_RECEIVERCONFIG_H__
#define __TEST_BASERF_BASECOMMANDS_RECEIVERCONFIG_H__
...
#if TEST_RECEIVER_LED_TRACING
	#define TEST_RECEIVER_LED_TRACING_SEND	Board::D4
	#define TEST_RECEIVER_LED_TRACING_RECV	Board::D5
	#define TEST_RECEIVER_LED_TRACING_ACK	Board::D6
	#define TEST_RECEIVER		Board::LED
...
#define TEST_LOG_RECEIVER		MW_FULL_DEBUG
