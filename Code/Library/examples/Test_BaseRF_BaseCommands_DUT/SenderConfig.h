 ...
 */
#ifndef __TEST_BASERF_BASECOMMANDS_SENDERCONFIG_H__
#define __TEST_BASERF_BASECOMMANDS_SENDERCONFIG_H__
...
#define TEST_SENDER_LED_TRACING		false

#if TEST_SENDER_LED_TRACING
	#define TEST_SENDER_LED_TRACING_SEND	Board::D4
	#define TEST_SENDER_LED_TRACING_RECV	Board::D5
	#define TEST_SENDER_LED_TRACING_ACK	Board::D6
	#define TEST_SENDER		Board::LED
...
#define TEST_SENDER_ROUTECACHE_TABLE_EEPROM_OFFSET 128
