	...
	namespace L3 {
		...
		namespace NetworkV1 {
			...
			public:
				...
				class ZeroConfListener {
					public:
						...
						//called to request a factory reset
			...
			public:
				...
				static const uint8_t ZC_SUBCODE_ZCSFACTORYRESET	= 255;
			...
			protected:
				...
				uint8_t processZCFactoryReset(SerialMessageAdapter::serialmsg_t* msg);
			...
			public:
				...
				bool processConfigSequence(uint16_t initTimeout, uint16_t deinitTimeout, uint16_t nextMsgTimeout);
