 ...
 */
public class MRFGetRouteRes extends AbstractMessage implements Constants {

    public Route route;

    public MRFGetRouteRes(byte seq) {
        super(seq, NS_CODE, NS_SUBCODE_RFGETROUTERES);
        route = new Route();
    }

    @Override
    public void toString(PrintWriter writer, String rowPrefix, String rowSuffix, String separator) {
        writer.print("MRFGetRouteRes: ");route.toString(writer, rowPrefix, rowSuffix, separator);
    }

    @Override
    public AbstractMessage deserialize(MessageData msg) throws IOException {
        MRFGetRouteRes result = new MRFGetRouteRes(msg.seq);
