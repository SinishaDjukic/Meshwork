...
BinaryPinSwitch 	ep_0_0(NULL, NULL, false, NULL);
BinaryPinSwitch 	ep_0_1(NULL, NULL, false, NULL);
BinaryPinSwitch 	ep_0_2(NULL, NULL, false, NULL);
...
BinaryPinSensor 	ep_1_0(NULL, NULL, false, NULL);
MultilevelPinSensor ep_1_1(NULL, NULL, false, NULL);
